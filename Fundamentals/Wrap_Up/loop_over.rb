#loop or iterate over the contacts hash from exercise 12, and populate the associated data from the contact_data array. 
...
contacts.each_with_index do |(key, value), index|
  info.each do |type|
    value[type] = contact_data[index].shift
  end
end
